            ...
            <div className="relative z-10 p-5">
                    ...
                    {data?.community ? (
                        <div className="flex items-center gap-3">
                            <div className="relative group">
                                <div
                                    className="absolute inset-0 bg-gradient-to-br from-blue-400 to-purple-500 rounded-full blur-[2px] opacity-20 group-hover:opacity-30 transition-opacity"></div>
                                <Image
                                ...
                                />
                                <div
                                    className="absolute -bottom-1 -right-1 w-6 h-6 bg-white rounded-full flex items-center justify-center p-[2px] border border-gray-100">
                                    <Image
                ...
                <div className="flex justify-between pt-4 border-t border-gray-100">
                    <form
                        ...
                        action={() => {
                            !data?.allow_actions && isPublicPage
                                ? dispatch(setOpenLoginModal(true))
                                : like();
                        }}
                        ref={formRef}
            ...
            >
              {optimisticIsLiked ? (
                  <div className="flex items-center justify-center gap-2">
                      ...
                      <div className="text-blue-500 font-medium text-[14px]">
                  ...
                  <div className="flex items-center justify-center gap-2">
                    ...
                    >
                        ...
                        />
                        <span className="text-gray-500 group-hover:text-blue-500 transition-colors text-[14px]">
              Share
            </span>
                    </button>
                </div>
