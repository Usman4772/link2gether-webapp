...
import { approveJoinRequest } from "@/utils/backend/modules/auth/services/admin.community.services";
...
export async function POST(req: NextRequest) {
  try {
    ...
    await approveJoinRequest(community, req);
    return SUCCESS_RESPONSE([], 200, "Request approved successfully");
  } catch (error) {
