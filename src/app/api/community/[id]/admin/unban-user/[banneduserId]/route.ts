...
import {unbanUser} from "@/utils/backend/modules/auth/services/community.services";
...
export async function PUT(req: NextRequest) {
    try {
        ...
        await unbanUser(bannedUserId, community);
        return SUCCESS_RESPONSE([], 200, `User has been un-banned successfully`);
    } catch (error) {
